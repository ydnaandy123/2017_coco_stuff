...
from model import dense_ae_stacked_two
...
tf.flags.DEFINE_string("network_name", "dense_ae_stacked_two", "the name og this network")
    ...
    with tf.Graph().as_default():
        ...
        with tf.name_scope(name='Network'):
            ...
            with tf.variable_scope(FLAGS.network_name, reuse=False):
                logits_stacks, logits_up = dense_ae_stacked_two(
            ...
            with tf.variable_scope(FLAGS.network_name, reuse=True):
                logits_stacks_test, logits_up_test = dense_ae_stacked_two(
