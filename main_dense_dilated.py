...
tf.flags.DEFINE_string("logs_dir", "./logs_dense_super", "path to logs directory")
...
def main(args=None):
    ...
    with tf.Graph().as_default():
        ...
        with tf.name_scope(name='Network'):
            network_name = 'dense_super'
            # Inference
            with tf.variable_scope(network_name, reuse=False):
                logits, logits_up = dense_super(
            ...
            with tf.variable_scope(network_name, reuse=True):
                logits_infer, logits_infer_up = dense_super(
