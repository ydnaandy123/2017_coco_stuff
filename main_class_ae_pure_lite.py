...
from model import ae_pure_lite, get_shape
...
tf.flags.DEFINE_string("network_name", "class_ae_pure_lite", "the name og this network")
    ...
    with tf.Graph().as_default():
        ...
        with tf.name_scope(name='Network'):
            ...
            with tf.variable_scope(FLAGS.network_name, reuse=False):
                logits_stacks, logits_up = ae_pure_lite(
            ...
            with tf.variable_scope(FLAGS.network_name, reuse=True):
                logits_stacks_test, logits_up_test = ae_pure_lite(
