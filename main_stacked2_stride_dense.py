...
from model import stacked2_stride_dense
...
tf.flags.DEFINE_string("network_name", "stacked2_stride_dense", "the name og this network")
    ...
    with tf.Graph().as_default():
        ...
        with tf.name_scope(name='Network'):
            ...
            with tf.variable_scope(FLAGS.network_name, reuse=False):
                logits_stacks, logits_up = stacked2_stride_dense(
            ...
            with tf.variable_scope(FLAGS.network_name, reuse=True):
                logits_stacks_test, logits_up_test = stacked2_stride_dense(
