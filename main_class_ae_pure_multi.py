...
from model import ae_pure_multi, get_shape
...
tf.flags.DEFINE_string("network_name", "class_ae_pure_multi", "the name og this network")
    ...
    with tf.Graph().as_default():
        ...
        with tf.name_scope(name='Network'):
            ...
            with tf.variable_scope(FLAGS.network_name, reuse=False):
                logits_stacks, logits_up = ae_pure_multi(
            ...
            with tf.variable_scope(FLAGS.network_name, reuse=True):
                logits_stacks_test, logits_up_test = ae_pure_multi(
        ...
        with tf.name_scope(name='Optimize'):
            ...
            loss = loss_stack_class + loss_stack_class_sup + loss_stack_class_sup_sup
